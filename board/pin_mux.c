...
void LPI2C1_DeinitPins(void)
{
    ...
    PORT_SetPinConfig(LPI2C1_INITPINS_LPI2C1_SDA_PORT, LPI2C1_INITPINS_LPI2C1_SDA_PIN, &portb4_pin2_config);
    ...
    PORT_SetPinConfig(LPI2C1_INITPINS_LPI2C1_SDA_PORT, LPI2C1_INITPINS_LPI2C1_SDA_PIN, &LPI2C1_SCL);
}
/***********************************************************************************************************************
 * EOF
 **********************************************************************************************************************/
